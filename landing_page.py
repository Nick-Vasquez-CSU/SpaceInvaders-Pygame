...
class LandingPage:
    ...
    def __init__(self, game):
        ...
        self.alien_one = Alien(game=game, alien_index=0, image_list=LandingPage.alien_one_imgs, 
                               v=Vector(), ul=(centerx - 120, 385))
        self.alien_two = Alien(game=game, alien_index=1, image_list=LandingPage.alien_two_imgs, 
                               v=Vector(), ul=(centerx - 180, 445))
        self.alien_three = Alien(game=game, alien_index=2, image_list=LandingPage.alien_three_imgs, 
                               v=Vector(), ul=(centerx - 150, 490))
        self.ufo = Alien(game=game, alien_index=3, image_list=LandingPage.ufo_imgs,
